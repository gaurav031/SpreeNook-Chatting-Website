...
var BsFullscreen = React.createElement(
  "svg",
...
var BsFullscreenExit = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", fill: "currentColor", viewBox: "0 0 16 16" },
...
var CiVolume = React.createElement(
  "svg",
...
var CiVolumeHigh = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "currentColor" },
  React.createElement(
    "g",
...
var CiVolumeMute = React.createElement(
  "svg",
...
var FaPlay = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", width: "24", height: "24", fill: "currentColor" },
...
var FaPause = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", width: "24", height: "24", fill: "currentColor" },
...
var FaClosedCaptioning = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512", width: "24", height: "24", fill: "currentColor" },
...
var FaRegClosedCaptioning = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512", width: "24", height: "24", fill: "currentColor" },
...
var IoSettings = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", width: "24", height: "24", fill: "currentColor" },
...
var IoSettingsOutline = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", width: "24", height: "24", fill: "currentColor" },
...
var RiMovieFill = React.createElement(
  "svg",
...
var RiMovieLine = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24", height: "24", fill: "currentColor" },
...
var TbRewindBackward10 = React.createElement(
  "svg",
...
var TbRewindForward10 = React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" },
  React.createElement("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
...
var CgMiniPlayer = React.createElement(
  "svg",
...
var RangeSlider = ({ min = 0, max = 100, value, changeHandler, color = "white" }) => {
  ...
  return React.createElement("input", { className: `_6pp-basic-slider slider-theme-${color}`, ref: inputRef, type: "range", min, max, value, id: "range", onChange: changeHandler });
};
var speedOptions = [0.5, 0.75, 1, 1.25, 1.5, 2];
var prefixZero = new Intl.NumberFormat(void 0, {
...
var VideoPlayer = ({ width = "40rem", height = "20.5rem", src, poster, captions, qualityOptions = [480, 720, 1080, 1440], setQuality }) => {
  const settingsPanelRef = (0, import_react.useRef)(null);
  const speedPanelRef = (0, import_react.useRef)(null);
  const videoPlayerRef = (0, import_react.useRef)(null);
  const isDragging = (0, import_react.useRef)(false);
  const [isLoading, setIsLoading] = (0, import_react.useState)(false);
  const [isPaused, setIsPaused] = (0, import_react.useState)(true);
  const [isMuted, setIsMuted] = (0, import_react.useState)(false);
  const [volume, setVolume] = (0, import_react.useState)(50);
  const [previousVolume, setPreviousVolume] = (0, import_react.useState)(volume);
  const [speed, setSpeed] = (0, import_react.useState)(1);
  const [isFullScreen, setIsFullScreen] = (0, import_react.useState)(false);
  const [isTheater, setIsTheater] = (0, import_react.useState)(false);
  const [isCaptions, setIsCaptions] = (0, import_react.useState)(false);
  const [duration, setDuration] = (0, import_react.useState)("00:00");
  const [currentTime, setCurrentTime] = (0, import_react.useState)("0:0");
  const [buffered, setBuffered] = (0, import_react.useState)(0);
  const [timelineProgress, setTimelineProgress] = (0, import_react.useState)(0);
  const [isSettingsOpen, setIsSettingsOpen] = (0, import_react.useState)(false);
  const [isSpeedOpen, setIsSpeedOpen] = (0, import_react.useState)(false);
  ...
  const handlePlayPause = () => setIsPaused((prev) => {
    var _a, _b;
    if (prev) {
      (_a = videoPlayerRef.current) == null ? void 0 : _a.play();
    } else {
      (_b = videoPlayerRef.current) == null ? void 0 : _b.pause();
    }
    return !prev;
  });
  ...
  const handleMiniPlayerChange = () => {
    var _a;
    return (_a = videoPlayerRef.current) == null ? void 0 : _a.requestPictureInPicture();
  };
  ...
  const handleMouseMove = (e) => {
    ...
    const percent = Math.min(Math.max(0, e.clientX - rect.left), rect.width) / rect.width * 100;
  ...
  const handleClickOutside = (0, import_react.useCallback)((event) => {
    if (settingsPanelRef.current && !settingsPanelRef.current.contains(event.target)) {
      setIsSettingsOpen(false);
    }
    if (speedPanelRef.current && !speedPanelRef.current.contains(event.target)) {
  ...
  const loadedDataHandler = (0, import_react.useCallback)(() => {
    const player = videoPlayerRef.current;
    if (player)
      setDuration(formatTime(videoPlayerRef.current.duration));
  }, [videoPlayerRef.current]);
  const timeupdateHandler = (0, import_react.useCallback)(() => {
    const player = videoPlayerRef.current;
    if (player) {
      ...
      if (player.buffered.length > 0) {
        bufferedPercentage = player.buffered.end(player.buffered.length - 1) / player.duration * 100;
      }
  ...
  const SettingPanel = isSettingsOpen && React.createElement(
    "div",
    { ref: settingsPanelRef, className: "_6pp-video-player-setting-panel" },
    React.createElement("ul", null, qualityOptions.map((i, idx) => React.createElement(
      "li",
      { key: i, style: {
  ...
  const SpeedPanel = isSpeedOpen && React.createElement(
    "div",
    { ref: speedPanelRef, className: "_6pp-video-player-speed-panel" },
    React.createElement("ul", null, speedOptions.map((i, idx) => React.createElement(
      "li",
      { key: i, style: {
        borderTopLeftRadius: idx === 0 ? "0.5rem" : 0,
        borderTopRightRadius: idx === 0 ? "0.5rem" : 0,
  ...
  const TimeLine = React.createElement(
    "div",
    { className: "_6pp-video-player-timeline-container", onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, onMouseDown: handleMouseDown },
  ...
  const ControlsPanel = React.createElement(
    ...
    React.createElement(
      "button",
      { title: "Plackback Speed", style: { fontSize: "1.25rem" }, onClick: toggleSpeed },
      speed,
      "x"
    ),
  ...
  return React.createElement(
    "div",
    { className: "_6pp-video-player-container", style: {
    ...
    React.createElement(
      "video",
      { ref: videoPlayerRef, src, className: "_6pp-video-player-video", style: {
        filter: isLoading ? "blur(5px)" : "none"
      }, onClick: handlePlayPause, poster, onWaiting: () => setIsLoading(true), onPlaying: () => setIsLoading(false) },
